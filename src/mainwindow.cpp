...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow{parent}, chart{new Chart{this}},
      ...
      actionConnect{new QAction{"Connect", this}}, actionDisconnect{new QAction{
                                                       "Disconnect", this}},
      actionPortSettings{new QAction{"Port", this}},
      actionClear{new QAction{"Clear", this}}, actionSaveImage{new QAction{
                                                   "Save image", this}},
  ...
  connect(actionChartType, &QAction::triggered, this,
          &MainWindow::statusBarUpdateChartType);
 ...
 *
 */
MainWindow::~MainWindow() { delete serialTransceiver; }
...
void MainWindow::saveImage() {
  auto fileName{
      createFileDialog(QFileDialog::AcceptSave, "Images (*.png)", "png")};
  if (fileName.isEmpty())
    return;
 ...
 *
 */
void MainWindow::clearChart() { chart->clear(); }
...
void MainWindow::saveData() {
  auto fileName{
      createFileDialog(QFileDialog::AcceptSave, "Text files (*.txt)", "txt")};
  QFile file(fileName);
...
void MainWindow::openData() {
  chart->clear();
  auto fileName =
      createFileDialog(QFileDialog::AcceptOpen, "Text files (*.txt)", "txt");
  QFile file(fileName);
